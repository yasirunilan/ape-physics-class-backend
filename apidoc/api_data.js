define({ "api": [
  ...
  },
  {
    ...
    "parameter": {
      "examples": [
        {
          "title": "Request-Example: Without Extra Data(Class Payments)",
        ...
        {
          "title": "Request-Example: With Extra Data(Practical Payments)",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>payment information</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Success-Response:Without Extra Data(Class Payments)",
        ...
        {
          "title": "Success-Response:With Extra Data(Practical Payments)",
          "content": "    HTTP/1.1 200 OK\n{\n  \"error\": false,\n  \"data\": {\n    \"slip\": \"data:image/jpeg;base64,\",\n    \"id\": 14,\n    \"date\": \"2021-10-10T00:00:00.000Z\",\n    \"userId\": 2,\n    \"classCategoryId\": 1,\n    \"amount\": 1000,\n    \"expireDate\": \"2021-11-10T00:00:00.000Z\",\n    \"extraData\": \"{\\\"practicals\\\":[1,2,3]}\",\n    \"slipFileType\": \"image/jpeg\",\n    \"updatedAt\": \"2021-06-27T06:04:48.981Z\",\n    \"createdAt\": \"2021-06-27T06:04:48.981Z\"\n  }\n}",
          "type": "json"
        }
      ]
  ...
  },
  {
    ...
    "parameter": {
      "examples": [
        {
          "title": "Request-Example: Successful Sign Up",
          "content": " {\n            \"username\": \"saman\",\n            \"password\": \"12345\",\n            \"firstName\": \"Yasiru\",\n            \"lastName\": \"Nilan\",\n            \"email\": \"ajith@gmail.com\",\n            \"nic\": \"1212323322313\",\n            \"phoneMain\": \"07023232232\",\n            \"phoneExtra\": \"07023232232\",\n            \"homePhone\": \"07023232232\",\n            \"city\": \"Matara\",\n            \"examYear\": \"2021\",\n            \"address\": \"Wimalasewana, Hingurupanagala, Kotapola\",\n\t\t    \"profilePictureImageType\": \"image/png\",\n\t\t\t\"profilePicture\": \"data:image/png;base64,iVBORw0KGgoAAAANSUhEUmCC\"\n        }\n }",
          "type": "json"
        }
      ]
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>signed up user information</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Success-Response:Successful Sign Up",
        ...
        {
          "title": "Success-Response:When user exists with same username",
          "content": "    HTTP/1.1 200 OK\n{\n  \"data\": [],\n  \"error\": true,\n  \"message\": \"User with Same Username Exists\"\n}",
          "type": "json"
        }
      ]
    },
    "filename": "api/v1/signup.js",
    "groupTitle": "User"
  },
  {
    "type": "patch",
